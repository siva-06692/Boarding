<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewApprovalList.aspx.cs" Inherits="Boarding.ViewApprovalList" %>
        ...
        <div class="grid-container">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText =" MRF Company ID" >
                        <ItemTemplate>
                        <asp:Label ID="lblmrfcompid" runat="server" Text='<%# Eval("MRF_Company_Id") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:BoundField DataField="MRF_Company_Name" HeaderText="MRF Company Name" />
