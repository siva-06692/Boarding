<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ApprovedMRFList.aspx.cs" Inherits="Boarding.ApprovedMRFList" %>
...
<body>
    <form>
        <div class="container form-container">
            ...
            <div class="row mb-2">
                  <div class="col-md-15">  
                       <label for="MRFlog" class="form-label">MRF Log</label>
